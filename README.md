...
* Real-world code issues `CONFIG` even when you never call it directly, this should not fail with an "unsupported operation" error.
...
Only the following parameters are actually honoured by the mock:
